    ...
    <div className="min-h-screen bg-gradient-subtle flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-foreground">Join Skillora</h1>
          <p className="text-muted-foreground mt-2">Create an account to start your skill development journey</p>
        </div>

        <Card className="border-border shadow-lg">
          <CardHeader className="space-y-1">
            <CardTitle className="text-2xl">Sign Up</CardTitle>
            <CardDescription>Create your Skillora account</CardDescription>
          </CardHeader>
